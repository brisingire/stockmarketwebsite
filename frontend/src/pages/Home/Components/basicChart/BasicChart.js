    ...
    return(
        <div className="basicChartContainer" style={{marginBottom:"10%"}}>
            ...
            <div className="priceInformation" >
                ...
                {priceChange>110?<FaArrowCircleUp style={{fontSize: "x-large", color: "green"}}/>:priceChange<95?<FaArrowAltCircleDown style={{fontSize: "x-large", color: "red"}}/>:<FaArrowAltCircleRight style={{fontSize: "x-large", color: "orange"}}/>}

                {priceChange>110?<p>{priceInformationText["increasing"]}</p>:priceChange<95?<p>{priceInformationText["declining"]}</p>:<p>{priceInformationText["steady"]}</p>}
            </div>
